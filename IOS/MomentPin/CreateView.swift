    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            Text("发布后可设置卡片文案（占位）")
                ...
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片提醒文案（占位）")
                .font(.caption2)
                .foregroundColor(.secondary)
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片触发条件（占位）")
                .font(.caption2)
                .foregroundColor(.secondary)
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片优先级（占位）")
                ...
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片内容来源（占位）")
                .font(.caption2)
                .foregroundColor(.secondary)
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片触发频次（占位）")
                .font(.caption2)
                .foregroundColor(.secondary)
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片触发时间（占位）")
                .font(.caption2)
                .foregroundColor(.secondary)
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片触发条件（占位）")
                ...
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片触发范围（占位）")
                .font(.caption2)
                .foregroundColor(.secondary)
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片触发对象（占位）")
                .font(.caption2)
                .foregroundColor(.secondary)
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片触发渠道（占位）")
                .font(.caption2)
                .foregroundColor(.secondary)
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片触发文案（占位）")
                .font(.caption2)
                .foregroundColor(.secondary)
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片触发冷却（占位）")
                .font(.caption2)
                .foregroundColor(.secondary)
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片触发频度（占位）")
                .font(.caption2)
                .foregroundColor(.secondary)
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片触发频次（占位）")
                ...
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片触发提示（占位）")
                .font(.caption2)
                .foregroundColor(.secondary)
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片触发策略（占位）")
                .font(.caption2)
                .foregroundColor(.secondary)
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片触发规则（占位）")
                .font(.caption2)
                .foregroundColor(.secondary)
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片触发频率（占位）")
                .font(.caption2)
                .foregroundColor(.secondary)
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片触发配额（占位）")
                .font(.caption2)
                .foregroundColor(.secondary)
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片触发时段（占位）")
                .font(.caption2)
                .foregroundColor(.secondary)
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片触发开关（占位）")
                ...
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片触发模式（占位）")
                .font(.caption2)
                .foregroundColor(.secondary)
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片触发节奏（占位）")
                .font(.caption2)
                .foregroundColor(.secondary)
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片触发预算（占位）")
                .font(.caption2)
                .foregroundColor(.secondary)
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            ...
            Text("发布后可设置卡片触发上限（占位）")
                ...
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片触发日限（占位）")
                .font(.caption2)
                .foregroundColor(.secondary)
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片触发月限（占位）")
                .font(.caption2)
                .foregroundColor(.secondary)
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片触发冷静期（占位）")
                .font(.caption2)
                .foregroundColor(.secondary)
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片触发次数（占位）")
                .font(.caption2)
                .foregroundColor(.secondary)
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片触发间隔（占位）")
                .font(.caption2)
                .foregroundColor(.secondary)
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
            Text("发布后可设置卡片触发时间窗（占位）")
                .font(.caption2)
                .foregroundColor(.secondary)
                .padding(.horizontal, 20)
                .padding(.bottom, 6)
